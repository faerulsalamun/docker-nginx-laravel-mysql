...
6. Run docker exec web composer install
7. Run docker exec web php artisan key:generate
8. Need migrate data ? Setting your .env in folder web > www and then run docker exec web php artisan migrate 
9. Happy coding :)
```
